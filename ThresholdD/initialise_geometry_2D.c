/********************************************************************
 ...
 Reads in heterogenous diffusion information, and allocates nearest 
...
/* this version sets up continuous diffusion with no-flux boundaries */
